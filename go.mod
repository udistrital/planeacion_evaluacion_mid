module github.com/udistrital/planeacion_evaluacion_mid

go 1.18

require (
	github.com/astaxie/beego v1.12.3
	github.com/udistrital/planeacion_mid v0.0.0-20240304202327-e5e32c7f91db
	github.com/udistrital/utils_oas v0.0.0-20240216215053-4b36173afca7
)
